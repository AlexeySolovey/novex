...
<head>
	...
	<meta name="keywords" content="керамейя, кирпич, клинкер, клинкерный, брусчатка, поризованные, керамические, блоки, рубероид, гидроизоляция, новекс, кирпичи, керамоблоки, рядовой, кровельные, стеновые, стройматериалы, Кривой Рог" />
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="item-advant">
						...
						<p>Склад в центре города</p>
					</div>
					<div class="item-advant">
						<div class="figure">
							<div class="logistic"></div>
						</div>
						<p>Логистическая служба</p>
					</div>
					<div class="item-advant">
						<div class="figure">
							<div class="avto"></div>
						</div>
						<p>Парк грузовых автомобилей</p>
					</div>
					<div class="item-advant">
						<div class="figure">
							<div class="save"></div>
						</div>
						<p>Хранение купленного товара</p>
					</div>
					<div class="item-advant">
						<div class="figure">
							<div class="deliv"></div>
						</div>
						<p>Доставка стройматериалов с завода на объект</p>
					</div>
				</div>
				<div class="col-md-12">
...
<!--                        <a href="price/price_by_klink.rar" class="open_price">Скачать прайс</a>-->
						...
						<div class="open_gallary">
							<a class="goods_gallery" rel="gallery" href="images/goods_bruschatka.png" title="первый слайд">
								<span>Галерея</span>
							</a>
						...
						<div class="tabs">
							...
							<div class="tab-content">
								<div class="tab-pane active fade in" id="main_about_klink_cherkov"> 
									...
									Основная цветовая гамма -  красный Рубин, коричневый, желтый Янтарь,  кремовый  Сапфир, белый Кристалл, также популярная гамма Флеш, имеющий оттенок от красно-коричневого до зеленовато-серого.<br/>
						...
						<div class="tabs">
							...
							<div class="tab-content">
								<div class="tab-pane active fade in" id="main_about_ruberoid_tehno">
									...
									<div class="text-center">
										<a href="#other_about_ruberoid_tehno" data-toggle="collapse" class="open_about collapsed">Подробнее о продукте</a>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="tab-pane active fade in" id="main_about_materialu_tehno">
									...
									<div class="collapse" id="other_about_materialu_tehno">
										<table class="table table-bordered">
											...
											<tbody>
												<tr>
													<td class="materials-type" colspan="5">Праймер технониколь</td>
												</tr>
												<tr>
													<td rowspan="2">
														№ 01
	...
	<section class="consultation">
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					<h2>Консультация</h2>
					<p>Наши специалисты помогут вам <br>выбрать нужный продукт</p>
					<button data-toggle="modal" data-target="#basicModal">Заказать звонок</button>
				</div>
			...
			<div class="row">
				<div class="col-md-offset-1 col-md-10">
					...
					<div class="hidden-sm hidden-md hidden-lg">
						...
						<div class="text-center">
							<a href="#more_about" data-toggle="collapse" class="open_about collapsed">читать далее</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-7">
					<button data-toggle="modal" data-target="#basicModal">Заказать звонок</button>
					<p class="hidden-xs hidden-sm ">Если же у вас остались вопросы, свяжитесь с нами.</p>
				</div>
			</div>
		</div>
	</footer>
